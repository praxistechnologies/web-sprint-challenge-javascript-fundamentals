...
// Because the nestedFunction is created inside another function; i.e., myFunction. Therefore, internal can have access to the outer variable "const internal = "Hello! I'm inside myFunction!";" as it has access to outer variables.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){
    let new_array = zooAnimals.map((item) => {
  ...
  */
  ...
  function USApop(zooAnimals){
    return zooAnimals.reduce((total, item) => (total += item.population), 0);
  }
...
const cuboidTwo = new CuboidMakerTwo({length: 5, width: 5, height:5})
